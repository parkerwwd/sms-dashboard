  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-slate-600 mt-2">Track your SMS campaigns and revenue</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-1 top-1 bottom-1 px-3 bg-green-600 text-white text-sm rounded-md hover:bg-green-700 disabled:bg-gray-400 flex items-center gap-1.5"
                >
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold text-slate-800">SMS Messages</h2>
            <button
              type="button"
              onClick={addMessage}
